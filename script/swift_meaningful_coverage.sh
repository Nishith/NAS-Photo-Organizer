...
MEANINGFUL_REGEX='/(BLAKE2bHasher|CopyPlanBuilder|DryRunPlanner|MediaDiscovery|PlanningPathBuilder|DeduplicationPlanner|PerceptualHash|UserFacingErrorMessage|RunHistoryIndexer|RunConfiguration\+Profiles|HybridOrganizerEngine|TransferExecutor|RevertExecutor|DeduplicateExecutor|ReorganizeExecutor|DedupeFeatureCache|PreviewReviewModels|LibraryHealthScanner|ClusterAnnotator|ClusterConfidenceScorer|DuplicateClusterer|EditVariantDetector|FingerprintIndex|ImportDuplicateChecker|PhotoQualityScorer|SafetyWarningDetector|FileSystemMonitor|BackgroundDedupeMonitor|FaceExpressionAnalyzer)\.swift$'
